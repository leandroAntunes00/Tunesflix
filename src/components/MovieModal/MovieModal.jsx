  ...
  return (
    <div className="tf-modal__backdrop" onClick={onClose} role="presentation">
      <div className="tf-modal" role="dialog" aria-modal="true" onClick={(e) => e.stopPropagation()}>
        <button className="tf-modal__close" onClick={onClose} aria-label="Fechar">×</button>
        ...
        {details && (
          <div className="tf-modal__content">
            <div className="tf-modal__header">
              ...
              <div className="tf-modal__meta">{details.release_date ? new Date(details.release_date).getFullYear() : ''} • {details.runtime ? details.runtime + ' min' : ''}</div>
            </div>
            ...
            <div className="tf-modal__body">
              ...
              <div className="tf-modal__info">
                ...
                <p><strong>Elenco:</strong> { (details.credits?.cast || []).slice(0,6).map(c=>c.name).join(', ') || '—' }</p>
